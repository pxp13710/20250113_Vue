...
<template>
  ...
  <div class="mb-3">
    ...
    <button @click.once="decOne">once</button> <!-- once => 한번만 실행 -->
    <button @click.shift="decOne">Key</button> <!-- ctrl, alt, shift, meta, left, middle, right-->
  </div>

  <div id="container" class="mb-3" @click="outer">
    <div id="inner" @click="one">ONE</div>
    <div id="inner" @click.stop="two">TWO</div> <!-- evt.stopPropagation() -->
  </div>
