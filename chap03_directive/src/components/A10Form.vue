...
<template>
  ...
  <form class="mb-5">
    ...
    <!-- 숫자로 강제 형변환 => number -->
    Number Field: <span class="orange">{{ formData.age + 1 }}</span
    ><br />
    ...
    CheckBox: <span class="orange">{{ formData.fruit.join(' - ') }}</span
    ><br />
    ...
    SelectBox: <span class="orange">{{ formData.language }}</span
    ><br />
    ...
    SelectBox Multi: <span class="orange">{{ formData.four.join(', ') }}</span
    ><br />
    ...
    <span class="orange">{{ formData.person }} / {{ formData.person.name }}</span
    ><br />
    <input
      type="radio"
      name="person"
      v-bind:value="{ name: '놀부', age: 30 }"
      v-model="formData.person" />놀부 <br />
    <input
      type="radio"
      name="person"
      :value="{ name: '흥부', age: 25 }"
      v-model="formData.person" />흥부 <br />
    <input
      type="radio"
      name="person"
      :value="{ name: '방자', age: 20 }"
      v-model="formData.person" />방자 <br />
    <br />
