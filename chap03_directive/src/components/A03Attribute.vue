...
export default {
  data() {
    return {
      ...
      myStyle: {backgroundColor: 'lightgray', color: 'orange', padding: '10px', marginBottom: '5px', fontWeight: 'bold'},
      size: 300,
      direction: 'width'
    }
  },
...
<template>
  ...
  <div>
    ...
    <div style="background-color: lightgray; padding: 10px; margin-bottom: 5px; font-weight: bold;">Hello World</div>
    <div v-bind:style="{backgroundColor: 'lightgray', padding: '10px', marginBottom: '5px', fontWeight: 'bold'}">Hello World</div>
